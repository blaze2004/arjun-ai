...
SAFETY_INPUTS = [
    "are you safe",
    "safe",
    "are you hacking my data",
    "hacked my data",
    "hacking data",
    "my data",
]
SAFETY_RESPONSES = [
    "Just relax, Your information is safe.",
    "I am not hacking your machine.",
    "I am just trying to give you my best. but not by hacking your data.",
    "I am sorry, you feel that way.",
]

# android use
ANDROID_INPUTS = [
    "can i use you in android",
    "can i use u in android",
    "can i use in my phone",
    "can i use u in my phone",
    "can i use you in my phone",
]
...
CREATION_RESPONSES = [
    "I have been created by Shubham Tiwari",
    "Shubham Tiwari is my creator.",
    "Shubham Tiwari",
]

CREATOR_INPUTS = [
    "who is Shubham Tiwari",
    "Shubham Tiwari",
    "Shubham",
...
CREATOR_RESPONSES = [
    ...
    "He is  my creator.",
    "Shubham Tiwari is a great mind.",
    "Because of him I am talking to you.",
]
...
ABILITIES_RESPONSES = [
    """I can perform various tasks like
    Calculations
...
chatinitializer_words = [
    "Tell me something about python",
    "Hello, how can I help you?",
    "Try saying tell me the time.",
    "Try saying, open notepad.",
    "Try saying, open chrome.",
    "Try saying, tell me today's date",
    ...
    def arjun_response(self, user_response):
        ...
        try:
            if user_response in initializer:
                ...
                query_words = query.split()
                result_words = [
                    word for word in query_words if word.lower() not in stop_words
                ]
                user_response = " ".join(result_words)
                ...
                "can i call you" in user_response
                or "can i change your name" in user_response
            ):
                ans = "You can't change my name."
                return ans

            elif (
                "search wikipedia for" in user_response
                or "tell me something about" in user_response
            ):
...
def search_web(message):
    if "youtube" in message:
        ...
        webbrowser.open(
            "https://www.youtube.com/results?search_query=" + "+".join(query.split())
        )
        return ans
        ...
        if "google" in message:
            ...
            webbrowser.open(
                "https://www.google.com/search?q=" + "+".join(message.split())
            )
            return
